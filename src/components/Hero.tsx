      ...
      <div className="max-w-7xl mx-auto text-center">
        <div className="mb-8">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent block">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="group bg-gradient-to-r from-violet-600 to-indigo-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:from-violet-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2">
              <span>Try Demo Now</span>
              <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl text-lg font-semibold hover:border-violet-300 hover:text-violet-600 transition-all duration-300">
              View Documentation
            </button>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="bg-white/60 backdrop-blur-sm p-8 rounded-2xl shadow-xl border border-gray-200 max-w-4xl mx-auto">
            <div className="grid grid-cols-3 gap-8 text-center">
              ...
              <div>
                <div className="text-3xl font-bold text-violet-600 mb-2">1M+</div>
